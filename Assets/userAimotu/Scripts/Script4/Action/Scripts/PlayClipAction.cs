...
[CreateAssetMenu(
    menuName = "Game/State Actions/Play Clip"
)]
public class PlayClipAction : StateAction
{
    ...
    public override IEnumerator Execute()
    {
        ...
        GameManager.Instance.PushUIBlock("VideoClip");
        ...
        yield return new WaitUntil(() =>
            ...
            GameManager.Instance.transitionMaskGroup != null
        );
        ...
        var mask = GameManager.Instance.transitionMaskGroup; // 黑色遮罩
        ...
        if (useFadeIn)
        {
            ...
            if (isAudioFade) GameManager.Instance.StartCoroutine(AudioManager.Instance.FadeBGM(0, duration));
      ...
      //  if (enableDebugLog) Debug.Log("[PlayAnimation] UI 已显示，准备播放视频");
        ...
        if (useFadeOut)
        {
            ...
            GameManager.Instance.StartCoroutine(AudioManager.Instance.FadeBGM(1f, fadeSpeed));
        ...
        GameManager.Instance.PopUIBlock("VideoClip");
